...
var texture_filenames_to_load = [ "stars.png", "text.png", "earth.tga", "sky.png", 
"gridtexture.png", "titlescreen.png", "galaxy.jpg", "speech1.png", "qblock.png", "peachtexture.jpg", "speech2.png", "speech3.png",
"later1.png", "later2.png", "later3.png", "later4.png", "doge.jpeg", "end.png" ];
...
{	this.string_map = { };	this.m_text = new text_line( 20 ); 		this.start_index = 0;	this.tick = 0;
	...
	this.basisElement = document.getElementById("basis");
	...
	this.animationNode = document.createTextNode("");
	this.basisNode = document.createTextNode("");
	this.thrustNode = document.createTextNode("");
	this.frameNode = document.createTextNode("");
	this.fpsNode = document.createTextNode("");

	this.timeElement.appendChild(this.timeNode);
	this.animationElement.appendChild(this.animationNode);
	this.basisElement.appendChild(this.basisNode);
	this.thrustElement.appendChild(this.thrustNode);
	this.frameElement.appendChild(this.frameNode);
	this.fpsElement.appendChild(this.fpsNode);
}
	...
	Debug_Screen.prototype.display = function(time)
	{
			...
			for( var i = 0, idx = this.start_index; i < 6 && i < strings.length; i++, idx = (idx + 1) % strings.length )
			{
			...
			this.m_text.set_string("");//this.m_text.set_string( "Controls:" );
	...
	debug_screen_object.frameNode.nodeValue = this.tick++;
	}
